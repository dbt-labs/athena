...
struct AdbcError *AthenaErrorFromArrayStream(struct ArrowArrayStream *,
                                             AdbcStatusCode *);
AdbcStatusCode AthenaDatabaseGetOption(struct AdbcDatabase *, const char *,
                                       char *, size_t *, struct AdbcError *);
AdbcStatusCode AthenaDatabaseGetOptionBytes(struct AdbcDatabase *, const char *,
                                            uint8_t *, size_t *,
                                            struct AdbcError *);
AdbcStatusCode AthenaDatabaseGetOptionDouble(struct AdbcDatabase *,
                                             const char *, double *,
                                             struct AdbcError *);
AdbcStatusCode AthenaDatabaseGetOptionInt(struct AdbcDatabase *, const char *,
                                          int64_t *, struct AdbcError *);
AdbcStatusCode AthenaDatabaseInit(struct AdbcDatabase *db,
                                  struct AdbcError *err);
AdbcStatusCode AthenaDatabaseNew(struct AdbcDatabase *db,
                                 struct AdbcError *err);
AdbcStatusCode AthenaDatabaseRelease(struct AdbcDatabase *db,
                                     struct AdbcError *err);
...
AdbcStatusCode AthenaDatabaseSetOptionBytes(struct AdbcDatabase *, const char *,
                                            ...
                                            struct AdbcError *);
AdbcStatusCode AthenaDatabaseSetOptionDouble(struct AdbcDatabase *,
                                             const char *, double,
                                             struct AdbcError *);
AdbcStatusCode AthenaDatabaseSetOptionInt(struct AdbcDatabase *, const char *,
                                          int64_t, struct AdbcError *);

AdbcStatusCode AthenaConnectionCancel(struct AdbcConnection *,
                                      struct AdbcError *);
...
AdbcStatusCode AthenaConnectionGetInfo(struct AdbcConnection *cnxn,
                                       ...
                                       struct AdbcError *err);
AdbcStatusCode
AthenaConnectionGetObjects(struct AdbcConnection *cnxn, int depth,
                           ...
                           struct AdbcError *err);
AdbcStatusCode AthenaConnectionGetOption(struct AdbcConnection *, const char *,
                                         char *, size_t *, struct AdbcError *);
AdbcStatusCode AthenaConnectionGetOptionBytes(struct AdbcConnection *,
                                              const char *, uint8_t *, size_t *,
                                              struct AdbcError *);
AdbcStatusCode AthenaConnectionGetOptionDouble(struct AdbcConnection *,
                                               const char *, double *,
                                               struct AdbcError *);
AdbcStatusCode AthenaConnectionGetOptionInt(struct AdbcConnection *,
                                            const char *, int64_t *,
                                            struct AdbcError *);
AdbcStatusCode AthenaConnectionGetStatistics(struct AdbcConnection *,
...
AdbcStatusCode AthenaConnectionInit(struct AdbcConnection *cnxn,
                                    ...
                                    struct AdbcError *err);
AdbcStatusCode AthenaConnectionNew(struct AdbcConnection *cnxn,
                                   struct AdbcError *err);
...
AdbcStatusCode AthenaConnectionRollback(struct AdbcConnection *cnxn,
                                        struct AdbcError *err);
AdbcStatusCode AthenaConnectionSetOption(struct AdbcConnection *cnxn,
                                         const char *key, const char *val,
                                         struct AdbcError *err);
AdbcStatusCode AthenaConnectionSetOptionBytes(struct AdbcConnection *,
                                              const char *, const uint8_t *,
                                              size_t, struct AdbcError *);
AdbcStatusCode AthenaConnectionSetOptionDouble(struct AdbcConnection *,
                                               const char *, double,
                                               struct AdbcError *);
AdbcStatusCode AthenaConnectionSetOptionInt(struct AdbcConnection *,
                                            const char *, int64_t,
                                            struct AdbcError *);
...
AdbcStatusCode AthenaStatementBindStream(struct AdbcStatement *stmt,
                                         ...
                                         struct AdbcError *err);
AdbcStatusCode AthenaStatementCancel(struct AdbcStatement *,
                                     struct AdbcError *);
AdbcStatusCode AthenaStatementExecuteQuery(struct AdbcStatement *stmt,
                                           ...
                                           struct AdbcError *err);
AdbcStatusCode
AthenaStatementExecutePartitions(struct AdbcStatement *stmt,
                                 struct ArrowSchema *schema,
...
AdbcStatusCode AthenaStatementExecutePartitionsTrampoline(
    ...
    struct AdbcError *err);
AdbcStatusCode AthenaStatementExecuteSchema(struct AdbcStatement *,
                                            struct ArrowSchema *,
                                            struct AdbcError *);
AdbcStatusCode AthenaStatementGetOption(struct AdbcStatement *, const char *,
                                        char *, size_t *, struct AdbcError *);
AdbcStatusCode AthenaStatementGetOptionBytes(struct AdbcStatement *,
                                             const char *, uint8_t *, size_t *,
                                             struct AdbcError *);
AdbcStatusCode AthenaStatementGetOptionDouble(struct AdbcStatement *,
                                              const char *, double *,
                                              struct AdbcError *);
...
AdbcStatusCode AthenaStatementRelease(struct AdbcStatement *stmt,
                                      struct AdbcError *err);
AdbcStatusCode AthenaStatementSetOption(struct AdbcStatement *stmt,
                                        const char *key, const char *value,
                                        struct AdbcError *err);
AdbcStatusCode AthenaStatementSetOptionBytes(struct AdbcStatement *,
                                             const char *, const uint8_t *,
                                             size_t, struct AdbcError *);
AdbcStatusCode AthenaStatementSetOptionDouble(struct AdbcStatement *,
                                              const char *, double,
                                              struct AdbcError *);
AdbcStatusCode AthenaStatementSetOptionInt(struct AdbcStatement *, const char *,
                                           int64_t, struct AdbcError *);
