...
struct AdbcErrorDetail AthenaErrorGetDetail(const struct AdbcError *error,
  ...
  return (struct AdbcErrorDetail){.key = details->keys[index],
...
AdbcStatusCode AdbcConnectionGetInfo(struct AdbcConnection *connection,
  ...
  return AthenaConnectionGetInfo(connection, info_codes, info_codes_length, out,
                                 error);
}
...
AdbcConnectionGetObjects(struct AdbcConnection *connection, int depth,
  ...
  if (out)
    memset(out, 0, sizeof(*out));
  return AthenaConnectionGetObjects(connection, depth, catalog, db_schema,
...
AdbcStatusCode AdbcConnectionGetStatistics(
  ...
  return AthenaConnectionGetStatistics(connection, catalog, db_schema,
                                       table_name, approximate, out, error);
}
...
AdbcStatusCode AdbcConnectionGetTableSchema(struct AdbcConnection *connection,
  ...
  return AthenaConnectionGetTableSchema(connection, catalog, db_schema,
